...
const FareSummary = ({ bookingData, calculateFare, isCalculating }) => {
  const {
    packageId,
    selectedMenus,
    guestCount,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="flex flex-col space-y-2">
            ...
            <div className="flex justify-between">
              ...
              <span className="font-medium text-gray-800">
                {eventTypeId ? 'Selected' : 'Not selected'}
              </span>
            </div>
            <div className="flex justify-between">
          ...
          <div className="flex flex-col space-y-2">
            <div className="flex justify-between">
              ...
              <span className="font-medium text-gray-800">
                {venueId ? 'Selected' : 'Not selected'}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500">Shift:</span>
              <span className="font-medium text-gray-800">
                {shiftId ? 'Selected' : 'Not selected'}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500">Package:</span>
              <span className="font-medium text-gray-800">
                {packageId ? 'Selected' : 'Not selected'}
              </span>
            </div>
            <div className="flex justify-between">
              <span className="text-gray-500">Menu Items:</span>
              <span className="font-medium text-gray-800">
                {getTotalMenuItems()} items selected
              </span>
            </div>
          </div>
        </div>
